...
# Default permissions (runtime)
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/permissions/default-permissions-nubiaparts.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/default-permissions/default-permissions-nubiaparts.xml
...
# LiveDisplay (Nubia custom)
PRODUCT_PACKAGES += \
    vendor.lineage.livedisplay-service.nubia
